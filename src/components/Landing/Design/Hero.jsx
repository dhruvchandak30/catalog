...
const Hero = () => {
  return (
    <div className="lg:h-screen  h-full HeroBg  text-white ">
      <div className=" flex lg:flex-row flex-col justify-evenly items-center align-middle  gap-16">
        <div
          data-aos="fade-up"
          data-aos-duration="2000"
          className="flex flex-col lg:p-4 pl-4 gap-8 text-left    justify-center"
        >
          ...
          <div className="">
            <input
              className="p-2.5 lg:w-[20rem] w-[10rem] text-black  rounded-l-2xl"
              type="email"
              placeholder="Gmail"
            ></input>
          ...
          <div className="flex flex-row justify-start lg:gap-16 gap-4 ">
            <div className="flex flex-col font-bold gap-4">
              <div className="lg:text-5xl text-4xl">33+</div>
              <div className=" text-xl">Variety</div>
            </div>
            <div className="flex flex-col font-bold gap-4">
              <div className="lg:text-5xl text-4xl">100+</div>
              <div className=" text-xl">Projects</div>
            </div>
            <div className="flex flex-col font-bold gap-4">
              <div className="lg:text-5xl text-4xl">200+</div>
